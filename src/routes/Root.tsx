...
export default function RootRoute() {
  return (
    <>
      <GithubCorner href="https://github.com/halkeye/do-graphql-frontend-apollo" />
      <div className="flex w-screen h-screen text-gray-700">
        <div className="flex flex-col items-center w-16 pb-4 overflow-auto border-r border-gray-300">
          ...
          <a className="flex items-center justify-center flex-shrink-0 w-10 h-10 mt-4 mt-auto rounded hover:bg-gray-300"
            href="#">
            <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
        ...
        <div className="flex flex-col w-56 border-r border-gray-300">
          ...
          <div className="flex flex-col flex-grow p-4 overflow-auto">
            <React.Suspense><Sidebar /></React.Suspense>
          </div>
        </div>
        <div className="flex flex-col flex-grow">
          <div className="flex items-center flex-shrink-0 h-16 px-8 border-b border-gray-300">
            ...
            <button className="relative ml-2 text-sm focus:outline-none group">
              <div className="flex items-center justify-between w-10 h-10 rounded hover:bg-gray-300">
                <svg className="w-5 h-5 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
          ...
          <div className="flex-grow p-6 overflow-auto bg-gray-200">
            <div className="w-full gap-6">
              <React.Suspense fallback={<Hourglass
                visible={true}
                height="80"
                width="80"
