...
if (!bearerToken || bearerToken === 'null') {
  ...
  location.hash = "";
  if (!bearerToken || bearerToken === 'null') {
    location.assign(`https://cloud.digitalocean.com/v1/oauth/authorize?client_id=${encodeURIComponent(import.meta.env.VITE_DO_CLIENT_ID || '')}&redirect_uri=${encodeURIComponent(window.location.origin)}&response_type=token`)
  }
} else {
